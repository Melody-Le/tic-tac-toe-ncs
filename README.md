...
| --------------------------------------------------------------------------- | ----------------------------------------------------------------- | ------------------------------------------------------------------- | ----------------------------------------------------------------- |
| <img src="./demo/extraSmallDevice.png" alt="extraSmallDevice" width="100"/> | <img src="./demo/smallDevice.png" alt="smallDevice" width="400"/> | <img src="./demo/mediumDevice.png" alt="mediumDevice" width="400"/> | <img src="./demo/largeDevice.png" alt="largeDevice" width="400"/> |

[![test mobile responsive](./demo/mobileResponsiveFlow.GIF)](https://www.youtube.com/watch?v=tMRzaXXHZ3c)

### Game Flow

[![test game flow](./demo/gameFlow.GIF)](https://www.youtube.com/watch?v=2rhGlDuRRNw)
